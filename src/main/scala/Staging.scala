...
trait Staging extends App {
  ...
  // local file path
  val trips_loc = "/Users/ishrathnayeem/IntelliJ IDEA/mcit/gtfs_stm/trips.txt"
  val frequencies_loc = "/Users/ishrathnayeem/IntelliJ IDEA/mcit/gtfs_stm/frequencies.txt"
  val calender_dat_loc = "/Users/ishrathnayeem/IntelliJ IDEA/mcit/gtfs_stm/calendar_dates.txt"
  
  //connecting to athena
  val driverName: String = "com.simba.athena.jdbc.Driver"
  Class.forName(driverName)
  val connection: Connection = DriverManager
    .getConnection("jdbc:awsathena://AwsRegion=us-east-1;S3OutputLocation=s3://ishrath/1/;" +
